...
const int stepsPerTest = 800; // total steps per move
const int startDelay = 900;   // slowest delay (µs)
const int minDelay = 200;     // fastest delay (µs)
const int rampSteps = 200;    // how many steps to ramp up/down
